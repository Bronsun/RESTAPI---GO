...
type User struct {
	...
	Links    string `boil:"links" json:"links" toml:"links" yaml:"links"`
...
var (
	userColumns               = []string{"id", "login", "password", "links"}
	userColumnsWithoutDefault = []string{"login", "password", "links"}
...
// UserLinksG retrieves all the user_link's user link.
func (o *User) UserLinksG(mods ...qm.QueryMod) userLinkQuery {
	return o.UserLinks(boil.GetDB(), mods...)
}

// UserLinks retrieves all the user_link's user link with an executor.
func (o *User) UserLinks(exec boil.Executor, mods ...qm.QueryMod) userLinkQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"user_link\".\"user_id\"=?", o.ID),
	)

	query := UserLinks(exec, queryMods...)
	queries.SetFrom(query.Query, "\"user_link\"")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"\"user_link\".*"})
	}
...
func (userL) LoadUserLinks(e boil.Executor, singular bool, maybeUser interface{}) error {
	var slice []*User
	var object *User
	...
	query := fmt.Sprintf(
		"select * from \"user_link\" where \"user_id\" in (%s)",
	...
	if err != nil {
		return errors.Wrap(err, "failed to eager load user_link")
	}
	defer results.Close()

	var resultSlice []*UserLink
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice user_link")
	}
...
// AddUserLinksG adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.UserLinks.
// Sets related.R.User appropriately.
// Uses the global database handle.
func (o *User) AddUserLinksG(insert bool, related ...*UserLink) error {
	return o.AddUserLinks(boil.GetDB(), insert, related...)
}

// AddUserLinksP adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.UserLinks.
// Sets related.R.User appropriately.
// Panics on error.
func (o *User) AddUserLinksP(exec boil.Executor, insert bool, related ...*UserLink) {
	if err := o.AddUserLinks(exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// AddUserLinksGP adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.UserLinks.
// Sets related.R.User appropriately.
// Uses the global database handle and panics on error.
func (o *User) AddUserLinksGP(insert bool, related ...*UserLink) {
	if err := o.AddUserLinks(boil.GetDB(), insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}
...
// Appends related to o.R.UserLinks.
// Sets related.R.User appropriately.
func (o *User) AddUserLinks(exec boil.Executor, insert bool, related ...*UserLink) error {
	var err error
...
// SetUserLinksG removes all previously related items of the
// user replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.User's UserLinks accordingly.
// Replaces o.R.UserLinks with related.
// Sets related.R.User's UserLinks accordingly.
// Uses the global database handle.
func (o *User) SetUserLinksG(insert bool, related ...*UserLink) error {
	return o.SetUserLinks(boil.GetDB(), insert, related...)
}

// SetUserLinksP removes all previously related items of the
// user replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.User's UserLinks accordingly.
// Replaces o.R.UserLinks with related.
// Sets related.R.User's UserLinks accordingly.
// Panics on error.
func (o *User) SetUserLinksP(exec boil.Executor, insert bool, related ...*UserLink) {
	if err := o.SetUserLinks(exec, insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetUserLinksGP removes all previously related items of the
// user replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.User's UserLinks accordingly.
// Replaces o.R.UserLinks with related.
// Sets related.R.User's UserLinks accordingly.
// Uses the global database handle and panics on error.
func (o *User) SetUserLinksGP(insert bool, related ...*UserLink) {
	if err := o.SetUserLinks(boil.GetDB(), insert, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// SetUserLinks removes all previously related items of the
// user replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.User's UserLinks accordingly.
// Replaces o.R.UserLinks with related.
// Sets related.R.User's UserLinks accordingly.
func (o *User) SetUserLinks(exec boil.Executor, insert bool, related ...*UserLink) error {
	query := "update \"user_link\" set \"user_id\" = null where \"user_id\" = $1"
	...
	return o.AddUserLinks(exec, insert, related...)
}

// RemoveUserLinksG relationships from objects passed in.
// Removes related items from R.UserLinks (uses pointer comparison, removal does not keep order)
// Sets related.R.User.
// Uses the global database handle.
func (o *User) RemoveUserLinksG(related ...*UserLink) error {
	return o.RemoveUserLinks(boil.GetDB(), related...)
}

// RemoveUserLinksP relationships from objects passed in.
// Removes related items from R.UserLinks (uses pointer comparison, removal does not keep order)
// Sets related.R.User.
// Panics on error.
func (o *User) RemoveUserLinksP(exec boil.Executor, related ...*UserLink) {
	if err := o.RemoveUserLinks(exec, related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// RemoveUserLinksGP relationships from objects passed in.
// Removes related items from R.UserLinks (uses pointer comparison, removal does not keep order)
// Sets related.R.User.
// Uses the global database handle and panics on error.
func (o *User) RemoveUserLinksGP(related ...*UserLink) {
	if err := o.RemoveUserLinks(boil.GetDB(), related...); err != nil {
		panic(boil.WrapErr(err))
	}
}

// RemoveUserLinks relationships from objects passed in.
// Removes related items from R.UserLinks (uses pointer comparison, removal does not keep order)
// Sets related.R.User.
func (o *User) RemoveUserLinks(exec boil.Executor, related ...*UserLink) error {
	var err error
	for _, rel := range related {
		rel.UserID.Valid = false
		if rel.R != nil {
	...
	for _, rel := range related {
		for i, ri := range o.R.UserLinks {
			if rel != ri {
				continue
			}

			ln := len(o.R.UserLinks)
			if ln > 1 && i < ln-1 {
				o.R.UserLinks[i] = o.R.UserLinks[ln-1]
			}
			o.R.UserLinks = o.R.UserLinks[:ln-1]
			break
		}
	}
